...
class ResNet3D(nn.Module):
    ...
    def __init__(self, block, layers, in_channels, num_classes, shortcut_type='B', no_cuda=False):
        self.inplanes = 64
...
if __name__ == '__main__':
    model_resnet10 = resnet10_3d(in_channels=5, num_classes=32)
    model_resnet101 = resnet101_3d(in_channels=5, num_classes=32)
    x = torch.zeros([1,5,128,128,128]).float()
    y = model_resnet101(x)
    print(y.shape)
