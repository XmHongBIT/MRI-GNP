...
class SqueezeNet3D(nn.Module):
    ...
    def __init__(self, sample_size=112, sample_duration=16, num_classes=27, n_input_channels=3):
        super().__init__()
        ...
        self.features = nn.Sequential(
            nn.Conv3d(n_input_channels, 64, kernel_size=3, stride=(
                1, 2, 2), padding=(1, 1, 1)),
            nn.BatchNorm3d(64),
...
if __name__ == '__main__':
    import torch
    model = SqueezeNet3D(112, 16, num_classes = 128, n_input_channels=5).to('cuda:2')
