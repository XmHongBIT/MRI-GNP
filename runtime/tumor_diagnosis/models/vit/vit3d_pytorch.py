...
if __name__ == '__main__':
    model = ViT3D(image_size=(128,128,128),patch_size=8,num_classes=1024, dim=1024,depth=4, heads=4, mlp_dim=1024, channels=4).to('cuda:0')
    x = torch.ones([1,4,128,128,128]).to('cuda:0')
    print(model(x).shape)
